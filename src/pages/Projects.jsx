...
const Projects = () => {
    const projects = [
        ...
        { image: portfolio, name: "Personal Portfolio", description: "A custom-built portfolio website, created entirely from scratch to showcase my work. This project serves as a practical demonstration of my development process, focusing on clean code, responsive design, and a user-friendly interface.", stack: ["React", "Tailwind"], githubUrl: "https://github.com/guilhermeferreiragomes/municipal", liveUrl: null },
